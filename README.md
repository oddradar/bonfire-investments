...
## Goals
    ...
    Run locally, host later, and explore dapps/mesh networks

    Create a financial investments webapp that reflects my vision of user control
...
## Future Plans
    ...
    Hosting on Netlify, Vercel, or homelab

    Integration with Bonfire framework

    Decentralized dapps and mesh networks
